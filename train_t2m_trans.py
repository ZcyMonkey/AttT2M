...
args.vq_dir= os.path.join("/data/zhongchongyang/motiondiffuse/text2motion/data/KIT-ML" if args.dataname == 'kit' else "/data/zhongchongyang/TTM/HumanML3D-main/HumanML3D", f'{args.vq_name}')
...
while nb_iter <= args.total_iter:
    ...
    cls_pred = trans_encoder(a_indices, feat_clip_text,word_emb)
