...
class Text2MotionDataset(data.Dataset):
    def __init__(self, dataset_name, is_test, w_vectorizer, feat_bias = 5, max_text_len = 20, unit_length = 4):
        ...
        if dataset_name == 't2m':
            self.data_root = '/data/zhongchongyang/TTM/HumanML3D-main/HumanML3D'
            ...
            self.data_root = '/data/zhongchongyang/motiondiffuse/text2motion/data/KIT-ML'
            self.motion_dir = pjoin(self.data_root, 'new_joint_vecs')
            self.text_dir = pjoin(self.data_root, 'texts')
            self.joints_num = 21
            radius = 240 * 8
            ...
            self.meta_dir = '/data/zhongchongyang/T2M_GPT/checkpoints/kit/Comp_v6_KLD005/meta'
